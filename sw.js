const CACHE_NAME = "amara-colors-v14";
const APP_SHELL = [
  "./",
  "./index.html",
  ...
  "./coloring/music/singer.svg",
  "./coloring/music/dancer.svg",
  "./coloring/music/boy-band.svg",
  "./coloring/cute/cute-monster.svg",
  "./coloring/cute/baby-bunny.svg",
  "./coloring/cute/doll.svg",
